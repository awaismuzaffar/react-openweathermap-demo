...
export const LABEL_PRESSURE = 'Pressure';
export const LABEL_SEA_LEVEL = 'Sea level';
export const LABEL_GRND_LEVEL = 'Grand level';
export const LABEL_HUMIDITY = 'Humidity';

export const LABEL_HPA = 'hPa';

export const LABEL_MINUS_3_HRS = '-3 Hours.'
...
export const LABEL_FETCHING_MSG = 'Fetching...';
